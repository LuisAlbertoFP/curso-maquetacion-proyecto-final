...
var getMovements = function getMovements(accountId) {
...
exports.mapMovementListApiToVm = void 0;

var mapMovementListApiToVm = function mapMovementListApiToVm(movementList) {
...
},{"./element.helpers":"common/helpers/element.helpers.js"}],"common-app/api/account.api.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../node_modules/axios/index.js"}],"common-app/mappers/account.mappers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapAccountApiToVm = void 0;
...
var _account = require("../../common-app/api/account.api");

var _account2 = require("../../common-app/mappers/account.mappers");

var params = _router.history.getParams();

var accountId = params.id || 0;
(0, _movements.getMovements)(accountId).then(function (movements) {
  var vmMovements = (0, _movements3.mapMovementListApiToVm)(movements);
  (0, _movements2.addMovementRows)(vmMovements);
});
(0, _account.getAccount)(accountId).then(function (apiAccount) {
  var account = (0, _account2.mapAccountApiToVm)(apiAccount);
  (0, _helpers.onSetValues)(account);
});
},{"./movements.api":"pages/movements/movements.api.js","./movements.helpers":"pages/movements/movements.helpers.js","./movements.mappers":"pages/movements/movements.mappers.js","../../core/router":"core/router/index.js","../../common/helpers":"common/helpers/index.js","../../common-app/api/account.api":"common-app/api/account.api.js","../../common-app/mappers/account.mappers":"common-app/mappers/account.mappers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
