...
exports.updateAccount = exports.insertAccount = void 0;
...
var updateAccount = function updateAccount(account) {
  return _axios.default.put("".concat(url, "/").concat(account.id), account).then(function (_ref2) {
    var data = _ref2.data;
    return data;
  });
};
...
},{"axios":"../node_modules/axios/index.js"}],"common-app/api/account.api.js":[function(require,module,exports) {
"use strict";
...
exports.mapAccountVmToApi = void 0;
...
},{}],"common-app/mappers/account.mappers.js":[function(require,module,exports) {
"use strict";
...
var _account3 = require("../../common-app/api/account.api");

var _account4 = require("./account.mappers");

var _account5 = require("../../common-app/mappers/account.mappers");
...
if (isEditMode) {
  (0, _account3.getAccount)(params.id).then(function (apiAccount) {
    account = (0, _account5.mapAccountApiToVm)(apiAccount);
...
var onSave = function onSave() {
  var apiAccount = (0, _account4.mapAccountVmToApi)(account);
...
},{"../../common/helpers":"common/helpers/index.js","../../core/router":"core/router/index.js","./account.validations":"pages/account/account.validations.js","./account.api":"pages/account/account.api.js","../../common-app/api/account.api":"common-app/api/account.api.js","./account.mappers":"pages/account/account.mappers.js","../../common-app/mappers/account.mappers":"common-app/mappers/account.mappers.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
