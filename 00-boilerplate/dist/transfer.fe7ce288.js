...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"common-app/api/account-list.api.js":[function(require,module,exports) {
"use strict";
...
var mapAccountListApiToVm = function mapAccountListApiToVm(accountList) {
  return Array.isArray(accountList) ? accountList.map(mapAccountApiToVm) : [];
};
...
var setErrorMessage = function setErrorMessage(id, message) {
  ...
  var messageElement = document.getElementById(errorId);

  if (messageElement) {
    Boolean(message) ? setElementClass(errorId) : removeElementClass(errorId);
...
_fonk.Validators.required.setErrorMessage('Requerido');

var validationSchema = {
  field: {
    accountId: [_fonk.Validators.required],
    iban: [_fonk.Validators.required, {
      validator: _fonkIbanValidator.iban,
    ...
    email: [_fonk.Validators.required, {
...
exports.formValidation = formValidation;
},{"@lemoncode/fonk":"../node_modules/@lemoncode/fonk/dist/@lemoncode/fonk.esm.js","@lemoncode/fonk-iban-validator":"../node_modules/@lemoncode/fonk-iban-validator/dist/@lemoncode/fonk-iban-validator.esm.js"}],"pages/transfer/transfer.js":[function(require,module,exports) {
"use strict";

var _accountList = require("../../common-app/api/account-list.api");

var _transfer = require("./transfer.mappers");
...
(0, _accountList.getAccountList)().then(function (apiAccountList) {
  var accounts = (0, _transfer.mapAccountListApiToVm)(apiAccountList);

  var params = _router.history.getParams();

  (0, _transfer2.setAccountOptions)(accounts, params.id);
});
var transfer = {
  accountId: '',
  iban: '',
...
var handleChangeValue = function handleChangeValue(id, event) {
  var value = event.target.value;
  transfer = _objectSpread(_objectSpread({}, transfer), {}, _defineProperty({}, id, value));

  _transfer3.formValidation.validateField(id, transfer[id]).then(function (result) {
...
},{"../../common-app/api/account-list.api":"common-app/api/account-list.api.js","./transfer.mappers":"pages/transfer/transfer.mappers.js","./transfer.helpers":"pages/transfer/transfer.helpers.js","../../core/router":"core/router/index.js","../../common/helpers":"common/helpers/index.js","./transfer.validations":"pages/transfer/transfer.validations.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
